...
async def connect(bot: Bot, update):
    ...
    wait_msg = await update.reply_text("<b>Group is under maintenance guyzz 🤧</b>\n\n<b>This may take a while but we will re-open soon.</b>😝🤸🏽")
    ...
    await wait_msg.edit_text(f"Maintenance was successfully completed 🥳\n Re-Opening soon Success Code = <code>{len(data)}</code> 😸")
